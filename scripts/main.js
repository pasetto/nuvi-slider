function nuvi_slider_init() {
	var sliderConfig = document.querySelectorAll(".nuvi_slider");
...
function nuviSliderDomReady() {
	if (document.querySelectorAll(".nuvi_slider") && document.querySelectorAll(".nuvi_slider").length > 0) {
		nuvi_slider_init();
	}
}
